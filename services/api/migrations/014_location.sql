...
-- context (either their global list, or a specific trip).
CREATE UNIQUE INDEX IF NOT EXISTS uq_saved_places_user_trip_placeid
    ON location.saved_places (user_id, COALESCE(trip_id, '00000000-0000-0000-0000-000000000000'::uuid), place_id)
